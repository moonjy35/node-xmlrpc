 ...
 */
Client.prototype.methodCallOrig = function methodCall(method, params, callback) {
...
/**
 * Monkey Patched [Client.prototype.methodCall] for Promise
 * Makes an XML-RPC call to the server specified by the constructor's options.
 *
 * @param {String} method     - The method name.
 * @param {Array} params      - Params to send in the call.
 * @return {Promise} Promise abount err and result
 */
Client.prototype.methodCall = function(method, params){
  return new Promise(function(resolve, reject){
    this.methodCallOrig(method, params, function(err, result){
      if(err){
        reject(err)
        return
      }
